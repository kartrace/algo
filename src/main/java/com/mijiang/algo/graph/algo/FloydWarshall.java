...
import com.mijiang.algo.graph.AdjMatrixEdgeWeightedDigraph;
import com.mijiang.algo.graph.DirectedEdge;
import com.mijiang.algo.graph.EdgeWeightedDigraph;
import com.mijiang.algo.graph.app.EdgeWeightedDirectedCycle;
...
public class FloydWarshall {
	...
	public Iterable<DirectedEdge> negativeCycle() {
		for (int v = 0; v < distTo.length; v++) {
			...
			if (distTo[v][v] < 0.0) {
				...
				EdgeWeightedDirectedCycle finder = new EdgeWeightedDirectedCycle(
						spt);
	...
	public static void main(String[] args) {
		...
		G.addEdge(new DirectedEdge(1, 0, 4));
		G.addEdge(new DirectedEdge(0, 2, -2));
		G.addEdge(new DirectedEdge(2, 3, 2));
		G.addEdge(new DirectedEdge(3, 1, -1));
		G.addEdge(new DirectedEdge(1, 4, 3));
		G.addEdge(new DirectedEdge(4, 2, -2));
