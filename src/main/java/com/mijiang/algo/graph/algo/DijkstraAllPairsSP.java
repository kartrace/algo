 ...
 * <tt>dist()</tt> and <tt>hasPath()</tt> methods take constant time and the
 * <tt>path()</tt> method takes time proportional to the number of edges in the
...
public class DijkstraAllPairsSP {
	 ...
	 * in the edge-weighted digraph <tt>G</tt>.
	 * 
	 * @param G
