...
import com.mijiang.algo.graph.DirectedDFS;
import com.mijiang.algo.stackqueue.In;

/**
 * The <tt>TransitiveClosure</tt> class represents a data type for computing the
...
public class TransitiveClosure {
	...
	/**
	 * Is there a directed path from vertex <tt>v</tt> to vertex <tt>w</tt> in
	 * the digraph?
	 * 
	 * @param v
	 *            the source vertex
	 * @param w
	 *            the target vertex
	 * @return <tt>true</tt> if there is a directed path from <tt>v</tt> to
	 *         <tt>w</tt>, <tt>false</tt> otherwise
	 */
