 ...
 * which connected component a given vertex lies; the <em>areConnected</em>
 ...
 * the <em>id</em>, <em>count</em>, <em>areConnected</em>, and <em>size</em>
...
public class CC {
	 ...
	 *         same connected component, and <tt>false</tt> otherwise
	 */
