...
import com.mijiang.algo.graph.SymbolDigraph;
 ...
 * the <em>hasOrder</em> operation takes constant time; the <em>order</em>
 * operation takes time proportional to <em>V</em>.
 * <p>
...
public class Topological {
	...
	/**
	 * Determines whether the digraph <tt>G</tt> has a topological order and, if
